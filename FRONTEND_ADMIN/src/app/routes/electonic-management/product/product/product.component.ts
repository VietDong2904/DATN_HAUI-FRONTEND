...
export class ProductComponent implements OnInit {
  constructor(
    ...
    this.columnDefs = [
      ...
      { field: 'code', headerName: 'Mã', minWidth: 100, sortable: true, filter: true },
      { field: 'name', headerName: 'Tên', sortable: true, filter: true, minWidth: 100 },
      { field: 'amoutDefault', headerName: 'Giá', sortable: true, filter: true, minWidth: 100 },
      { field: 'serialNumber', headerName: 'Số Seri', sortable: true, filter: true, minWidth: 100 },
  ...
  @ViewChild(ProductItemComponent, { static: false }) itemModal!: { initData: (arg0: {}, arg1: string) => void };
  ...
  deleteListItem(listId: [string]): Subscription {
    ...
    const promise = this.productService.delete(listId).subscribe(
      (res: any) => {
  ...
  initGridData(): Subscription {
    ...
    const rs = this.productService.getFilter(this.filter).subscribe(
      (res: any) => {
