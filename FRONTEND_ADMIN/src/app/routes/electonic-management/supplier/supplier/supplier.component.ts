...
import { ImageCellRenderComponent } from 'src/app/routes/resource/image-cell-render/image-cell-render.component';
...
export class SupplierComponent implements OnInit {
  constructor(
    ...
    this.columnDefs = [
      ...
      { field: 'avatarUrl', headerName: 'Logo', sortable: true, filter: true, minWidth: 100, cellRenderer: 'imageCellRender' },
    ...
    this.frameworkComponents = {
      imageCellRender: ImageCellRenderComponent,
  ...
  @ViewChild(SupplierItemComponent, { static: false }) itemModal!: { initData: (arg0: {}, arg1: string) => void };
  ...
  deleteListItem(listId: [string]): Subscription {
    ...
    const promise = this.supplierSerivce.delete(listId).subscribe(
      (res: any) => {
  ...
  initGridData(): Subscription {
    ...
    const rs = this.supplierSerivce.getFilter(this.filter).subscribe(
      (res: any) => {
