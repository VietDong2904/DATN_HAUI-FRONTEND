...
import { StatusQtvCellRenderComponent } from 'src/app/shared/ag-grid';
...
@Component({
  selector: 'app-qtv-modal',
  templateUrl: './qtv-modal.component.html',
  styleUrls: ['./qtv-modal.component.less'],
})
export class QtvModalComponent implements OnInit {
  ...
  constructor() {
    ...
    this.frameworkComponents = {
      statusDeleteCellRender: StatusQtvCellRenderComponent,
    };
  }
